        ...
        <div class="content">
            ...
            <div class="info-box">
                <div class="info-item">
                    ...
                    <span><strong>Date:</strong> <?php echo e(date('F j, Y')); ?></span>
                </div>
                <div class="info-item">
                    <span class="info-icon">⏰</span>
                    <span><strong>Time:</strong> <?php echo e(date('g:i A')); ?></span>
                </div>
                <div class="info-item">
                    <span class="info-icon">🔐</span>
            ...
            <div style="text-align: center; margin-top: 30px;">
                <a href="<?php echo e(env('APP_URL')); ?>/login" class="cta-button">Log In to Your Account</a>
            </div>
...
<?php /**PATH /var/www/resources/views/emails/password-changed.blade.php ENDPATH**/ ?>